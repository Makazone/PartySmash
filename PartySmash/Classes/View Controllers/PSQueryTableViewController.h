 ...
 */
@interface PSQueryTableViewController : UITableViewController <UITableViewDataSource, UITableViewDelegate>
...
/*
 @abstract Whether the table needs to recompute cell heights
 */
@property (nonatomic, assign, getter=needsRecompute) BOOL recompute;

@property (nonatomic) NSMutableArray *cellHeights;
@property int numberOfComputedHeights;
