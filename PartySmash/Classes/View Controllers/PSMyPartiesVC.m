...
//        cell = [tableView dequeueReusableCellWithIdentifier:invitaion_ok_cellid forIndexPath:indexPath];
    ...
    } else if (invitation.type == ACCEPT_REQUEST_TYPE || invitation.type == DECLINE_REQUEST_TYPE || invitation.type == SEND_RECOMMENDATION_TYPE || invitation.type == ACCEPT_INVITATION_TYPE || invitation.type == DECLINE_INVITATION_TYPE) {
        cell = [tableView dequeueReusableCellWithIdentifier:invitaion_ok_cellid forIndexPath:indexPath];
    }
